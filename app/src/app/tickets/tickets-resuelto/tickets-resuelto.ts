...
@Component({
  selector: 'app-tickets-resuelto',
  standalone: false,
  templateUrl: './tickets-resuelto.html',
  styleUrl: './tickets-resuelto.css',
})
export class TicketsResuelto {
  ...
  this.vjServiceTicket
    ...
    .subscribe({
      next: (resp) => {
        console.log('✅ Se resolvio el Ticket', resp);
        this.noti.success(
